...
def allocate_resources(camp_id, required_items, priority="general"):
    ...
    try:
        ...
        warehouse.food_capacity -= required_items.get('food', 0)
        warehouse.water_capacity -= required_items.get('water', 0)
        warehouse.essential_capacity -= required_items.get('essentials', 0)
        warehouse.clothes_capacity -= required_items.get('clothes', 0)
